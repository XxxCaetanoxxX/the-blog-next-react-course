...
export function Button({ variant = 'default', size = 'md', ...props }: ButtonProps) {
    ...
    const buttonVariants: Record<ButtonVariants, string> = {
        ...
        ghost: 'bg-slate-300 hover:bg-blue-400 text-slate-900',
    ...
    cursor-pointer transition disabled:bg-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed disabled:hover:bg-slate-200 disabled:hover:text-slate-300
    `;
